...
export default function MyPage() {
  ...
  return (
    <div className="flex flex-col bg-surface flex-1 pb-[60px]">
      ...
      {/* 로그아웃 확인 바텀시트 (Consistent with other sheets) */}
      <Drawer
        open={showLogout}
      ...
      >
        <div className="flex flex-col items-center px-5 pb-8 pt-3">
          <div className="mb-2 h-1 w-9 rounded-full bg-border"></div>
          ...
          <div className="flex w-full gap-2.5">
            <button
              className="flex h-12 flex-1 cursor-pointer items-center justify-center rounded-lg border border-border bg-white text-[15px] font-bold text-text active:scale-95 transition-all"
              onClick={() => setShowLogout(false)}
            >
              아니요
            </button>
            <button
              className="flex h-12 flex-1 cursor-pointer items-center justify-center rounded-lg border-none bg-[#ED4956] text-[15px] font-bold text-white shadow-lg shadow-red-100 active:scale-95 transition-all"
